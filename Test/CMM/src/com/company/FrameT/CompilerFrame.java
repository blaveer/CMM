...
import com.company.compiler.CMMParser;
import com.company.compiler.CMMSemanticAnalysis;
import com.company.model.FourCode;
...
public class CompilerFrame extends JFrame {
	...
	public CompilerFrame(String title) {
		...
		undoItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Z,
				ActionEvent.CTRL_MASK));
		redoItem = new JMenuItem("重  做", new ImageIcon(
				"images/redo.png"));
		redoItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R,
				ActionEvent.CTRL_MASK));
		copyItem = new JMenuItem("复  制", new ImageIcon(
				"images/copy.png"));
		copyItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C,
				ActionEvent.CTRL_MASK));
		cutItem = new JMenuItem("剪  切", new ImageIcon(
				"images/cut.png"));
		cutItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_X,
				ActionEvent.CTRL_MASK));
		pasteItem = new JMenuItem("粘  贴", new ImageIcon(
				"images/paste.png"));
		pasteItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_V,
				ActionEvent.CTRL_MASK));
		allItem = new JMenuItem("全  选", new ImageIcon(
				"images/all.png"));
		allItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A,
				ActionEvent.CTRL_MASK));
		searchItem = new JMenuItem("查  找", new ImageIcon(
				"images/search.png"));
		searchItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F,
				ActionEvent.CTRL_MASK));
		deleteItem = new JMenuItem("删  除", new ImageIcon(
				"images/delete.png"));
		...
		// 为窗口菜单添加子项
		startPageItem = new JMenuItem("开始页", new ImageIcon(
				"images/startpage.png"));
		startPageItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N,
				ActionEvent.ALT_MASK));
		newWindowItem = new JMenuItem("新建窗口", new ImageIcon(
				"images/window.png"));
		...
		// 为帮助菜单添加子项
		helpItem = new JMenuItem("帮 助", new ImageIcon(
				"images/help.png"));
		...
		tabbedPanel.add(interCodePanel,"中间代码");
	...
	public void generateCode()
	{
		...
		tabbedPanel.setComponentAt(2, new JScrollPane(ta_log));
